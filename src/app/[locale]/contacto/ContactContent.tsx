        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-5xl mx-auto">
            <motion.div
              ...
              transition={{ duration: 0.8, ease: [0.25, 0.46, 0.45, 0.94] }}
              className="bg-white rounded-2xl p-12 lg:p-16 shadow-sm"
            >
              <h2 className="text-4xl md:text-5xl font-playfair font-light text-gray-900 mb-12 tracking-tight text-center">
                ...
                {contactInfo.map((item, index) => {
                  ...
                  const content = (
                    <div className="flex items-start space-x-5">
                      ...
                      <div>
                        <h3 className="text-sm text-gray-500 font-light mb-2 tracking-widest uppercase">
                          {item.label(locale)}
                        </h3>
                        {isLink ? (
                          <a
                            href={item.href(t)}
                            className="text-lg md:text-xl text-gray-900 font-light hover:text-gray-700 transition-colors duration-200"
                          >
                            {item.value(t)}
                          </a>
                        ) : (
              ...
              >
                ...
                <a
                  ...
                  className="inline-block bg-white text-gray-900 px-10 py-4 rounded-full text-base font-light tracking-wide hover:bg-gray-100 transition-all duration-300 shadow-lg hover:shadow-xl"
                >
