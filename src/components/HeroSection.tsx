        ...
        <div className="text-center text-white px-6 max-w-6xl w-full">
          ...
          >
            <div className="inline-flex items-center space-x-2 bg-white/10 backdrop-blur-md rounded-full px-4 py-2 mb-8 border border-white/20">
              ...
              <span className="text-white text-xs font-light tracking-wider uppercase">{t.hero.badge}</span>
            </div>
          </motion.div>
          <motion.h1 
            className="text-5xl sm:text-6xl md:text-7xl lg:text-8xl font-playfair font-bold mb-6 md:mb-8 leading-[1.05] md:leading-tight tracking-tight md:whitespace-nowrap"
          ...
          >
            <Link
              ...
              className="inline-block bg-white text-black hover:bg-stone-100 px-8 py-4 rounded-full text-lg font-semibold transition-all duration-300 hover:shadow-2xl hover:scale-105"
            >
            ...
            <Link
              ...
              className="inline-block border-2 border-white/40 hover:border-white hover:bg-white/10 text-white px-8 py-4 rounded-full text-lg font-semibold transition-all duration-300 backdrop-blur-sm hover:scale-105"
            >
              <span className="flex items-center justify-center">
